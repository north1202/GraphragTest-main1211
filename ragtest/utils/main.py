...
INPUT_DIR = "E:\\work\\experiment\\GraphragTest-main\\ragtest\\inputs\\artifacts"
...
async def setup_llm_and_embedder():
    ...
    llm = ChatOpenAI(
        ...
        # # 调用其他模型  通过oneAPI
         api_base="http://192.168.3.12:3000/v1",  # 请求的API服务地址
         api_key="sk-McHCnmnBAvfZcEaM278087C5E84449BbB0613310C0985f01",  # API Key
         model="qwen-max",  # 本次使用的模型
         api_type=OpenaiApiType.OpenAI,
